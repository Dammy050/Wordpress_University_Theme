...
{
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyBw3SsVY1dUJ8theB1fc_jCA3AEhYbwwBM', NULL, '1.0', true);
...
add_action('after_setup_theme', 'university_features', $priority, $accepted_args);
...
// Redirect subscriber account out of admin and unto homepage
