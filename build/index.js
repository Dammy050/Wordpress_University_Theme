...
class MyNotes {
    ...
    makeNoteReadOnly(thisNote) {
        ...
        thisNote.find(".note-title-field, .note-body-field").attr("readonly", "readonlt").removeClass("note-active-field");
...
//                     <div class="one-third">
//                         <h2 class="search-overlay__section-title">Campuses</h2>
//                         ${results.campuses.length ? '<ul class="link-list min-list">' : '<p>No campuses matches that search. <a href="${universityData.root_url}/campusess">View all campuses</a></p>'}
//                             ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')}
//                         ${results.campuses.length ? '</ul>' : ''}
//                         <h2 class="search-overlay__section-title">Events</h2>
...
//     }
//     keyPressDispatcher(e) {
//         if (e.keyCode == 83 && !this.isOverlayOpen && !$("inout, textarea").is(':focus')) {
//             this.openOverlay();
//         }
//         if (e.keyCode == 27 && this.isOverlayOpen) {
//             this.closeOverlay();
...
//                     <div class="container">
//                         <i class="fa fa-search search-overlay__icon" aria-hidden="true"></i>
//                         <input type="text" class="search-term" placeholder="What are you lookign for?" id="search-term" autocomplete="off">
//                         <i class="fa fa-window-close search-overlay__close" aria-hidden="true"></i>
//                     </div>
//                 </div>
//                 <div class="container">
